...
import com.teamservice.teamservice.Enum.Position;
...
public class Player {
    ...
    public void updateCategory(Player player){
        ...
        if(!player.getPhoneNumber().isEmpty()&&!player.getPhoneNumber().isBlank()) this.setPhoneNumber(player.getPhoneNumber());
        ...
        if(player.getPosition() != null) this.setPosition(player.getPosition());
    }
}
