...
import chiba.dev.userservice.Utility.CsvHelper;
import chiba.dev.userservice.Utility.Extractor;
import chiba.dev.userservice.Utility.UserHelper;
...
public class UserService {
    ...
    public User update(String id,User user){
        ...
        original.setRegion(user.getRegion() != null ? user.getRegion() : original.getRegion());
